...
Version  : 24.08.0
Release  : 51
URL      : https://download.kde.org/stable/release-service/24.08.0/src/elisa-24.08.0.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.08.0/src/elisa-24.08.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.08.0/src/elisa-24.08.0.tar.xz.sig
...
%setup -q -n elisa-24.08.0
cd %{_builddir}/elisa-24.08.0
pushd ..
cp -a elisa-24.08.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1724640608
mkdir -p clr-build
pushd clr-build
