...
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/elisa-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/elisa-25.04.2.tar.xz.sig
...
%setup -q -n elisa-25.04.2
cd %{_builddir}/elisa-25.04.2
pushd ..
cp -a elisa-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749505612
mkdir -p clr-build
pushd clr-build
