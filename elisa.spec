...
Source0  : https://download.kde.org/stable/release-service/20.08.2/src/elisa-20.08.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.2/src/elisa-20.08.2.tar.xz.sig
...
%prep
%setup -q -n elisa-20.08.2
cd %{_builddir}/elisa-20.08.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602629511
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/elisa-20.08.2/COPYING %{buildroot}/usr/share/package-licenses/elisa/f45ee1c765646813b442ca58de72e20a64a7ddba
cp %{_builddir}/elisa-20.08.2/LICENSES/BSD-3-Clause.txt %{buildroot}/usr/share/package-licenses/elisa/9950d3fdce1cff1f71212fb5abd31453c6ee2f8c
cp %{_builddir}/elisa-20.08.2/LICENSES/CC-BY-SA-4.0.txt %{buildroot}/usr/share/package-licenses/elisa/7b3e5f0e946c0b599b04a45deebb1aaed782070d
cp %{_builddir}/elisa-20.08.2/LICENSES/CC0-1.0.txt %{buildroot}/usr/share/package-licenses/elisa/8287b608d3fa40ef401339fd907ca1260c964123
cp %{_builddir}/elisa-20.08.2/LICENSES/GPL-2.0-or-later.txt %{buildroot}/usr/share/package-licenses/elisa/e712eadfab0d2357c0f50f599ef35ee0d87534cb
cp %{_builddir}/elisa-20.08.2/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/elisa/6091db0aead0d90182b93d3c0d09ba93d188f907
cp %{_builddir}/elisa-20.08.2/LICENSES/LGPL-2.1-only.txt %{buildroot}/usr/share/package-licenses/elisa/3c3d7573e137d48253731c975ecf90d74cfa9efe
cp %{_builddir}/elisa-20.08.2/LICENSES/LGPL-3.0-only.txt %{buildroot}/usr/share/package-licenses/elisa/757b86330df80f81143d5916b3e92b4bcb1b1890
cp %{_builddir}/elisa-20.08.2/LICENSES/LGPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/elisa/757b86330df80f81143d5916b3e92b4bcb1b1890
pushd clr-build
%make_install
popd
%find_lang elisa
